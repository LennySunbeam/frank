...
function load_stylesheets()
{
    ...
    wp_register_style('stylesheet', get_template_directory_uri() . 'http://192.168.64.2/wordpress/wp-content/themes/frankleeroy/styles/style.css', '', 1, 'all');
    wp_enqueue_style('stylesheet');

    wp_register_style('stylesheet', get_template_directory_uri() . 'http://192.168.64.2/wordpress/wp-content/themes/frankleeroy/styles/app.css', '', 1, 'all');
    wp_enqueue_style('stylesheet');
}
